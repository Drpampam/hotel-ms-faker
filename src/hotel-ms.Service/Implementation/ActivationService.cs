    ...
    public class ActivationService : IActivationService
    {
            ...
            ActivateTenantRequestDTO request, string ipAddress)
        {
            ...
            await _context.Database.ExecuteSqlRawAsync(@"
                ...
                ALTER TABLE ""GuestProfile"" ADD COLUMN IF NOT EXISTS ""FullName""    varchar(200);
                ALTER TABLE ""GuestProfile"" ADD COLUMN IF NOT EXISTS ""Email""       varchar(200);
                ALTER TABLE ""GuestProfile"" ADD COLUMN IF NOT EXISTS ""PhoneNumber"" varchar(50);
                ...
                CREATE TABLE IF NOT EXISTS ""ReservationExpense"" (
                    ""Id""            bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
                    ""ReservationId"" bigint       NOT NULL,
