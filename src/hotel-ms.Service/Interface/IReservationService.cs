...
namespace hotelier_core_app.Service.Interface
{
    ...
    {
        Task<BaseResponse<ReservationResponseDTO>> CreateReservationAsync(CreateReservationRequestDTO request, AuditLog auditLog, string? callerEmail = null);
        Task<BaseResponse<ReservationResponseDTO>> UpdateReservationAsync(UpdateReservationRequestDTO request, AuditLog auditLog);
        Task<BaseResponse<ReservationResponseDTO>> GetReservationByIdAsync(long reservationId, string? callerEmail = null);
        Task<PageBaseResponse<List<ReservationResponseDTO>>> GetReservationsAsync(GetReservationsInputDTO input, string? callerEmail = null);
